...
const megamenu = [
  ...
  },
  {
    ...
    groups: [
      {
        title: "Catch the Word family",
        items: [
          { chip: "🎮", label: "All games", url: "/games/", desc: "Every typing game in one place." },
          { chip: "C", label: "Classic — falling words", url: "/practice/game/", desc: "Words fall, you type them. Three misses ends the round." },
          { chip: "∞", label: "Endless mode", url: "/practice/game/?mode=endless", desc: "Spawns forever, faster each catch. No miss cap." },
          { chip: "🎯", label: "Word Shooter", url: "/practice/game/?mode=shooter", desc: "Words drift sideways. Type to shoot them down." },
          { chip: "☄", label: "Asteroids", url: "/practice/game/?mode=asteroids", desc: "Words approach from all directions. Type before impact." },
          { chip: "💣", label: "Bomb Defuse", url: "/practice/game/?mode=bomb", desc: "Single bomb, shrinking timer. Defuse to spawn a faster one." },
          { chip: "🏰", label: "Tower Defense", url: "/practice/game/?mode=tower", desc: "Three lanes, base HP. Stop words before they reach you." },
          { chip: "⚡", label: "Combo Sprint", url: "/practice/game/?mode=combo-sprint", desc: "Fast horizontal words. No miss cap. Chain for huge multipliers." },
          { chip: "🎨", label: "Stroop Type", url: "/practice/game/?mode=stroop", desc: "Words painted in mismatched colors. Type the literal word." },
        ],
      },
      {
        title: "Race & combat",
        items: [
          { chip: "🏎", label: "Typing Race", url: "/practice/race/", desc: "Race a ghost AI to the finish. Pick your difficulty (40-100 WPM)." },
          { chip: "🐲", label: "Boss Battle", url: "/practice/boss/", desc: "HP bar, damage per word, level up after each defeat." },
          { chip: "🪢", label: "Hangman Speedrun", url: "/practice/hangman/", desc: "15-second puzzles. Type letters to solve before the noose closes." },
        ],
      },
      {
        title: "Puzzle & memory",
        items: [
          ...
          { chip: "⚡", label: "Bigram Drill", url: "/practice/bigrams/", desc: "60-second burst on short letter combos. Pure speed warm-up." },
          { chip: "★", label: "High scores", url: "/stats/#mode-bests", desc: "Best score per game." },
        ],
      },
    ],
    featured: { kind: "game-pitch", title: "Play Typing Race", cta: { label: "Open the game", url: "/practice/race/" } },
  },
  {
    label: "Insights",
    url: "/stats/",
