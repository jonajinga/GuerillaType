...
function populateContribute(p) {
  ...
  body.innerHTML = `
    <div class="mega-featured-note">
      ...
      <p class="mega-featured-note__body">GuerillaType exists because you use it. Free, no ads, no paywall -- it stays that way only as long as people care enough to send a quote, leave a review, or just say hi.</p>
