    ...
    if (!dismissed && lifetimeSessions >= 10) {
      testimonialPrompt = `
        <aside class="results__testimonial-prompt" id="tt-testimonial-prompt">
          <p>Enjoying Guerilla Type? <a href="/contribute/testimonial/" data-tip="Submit a short testimonial -- helps the project and may appear on the reviews page if you opt in.">Leave a testimonial →</a></p>
